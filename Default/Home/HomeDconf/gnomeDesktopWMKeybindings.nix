...

{
  dconf.settings = {
    "org/gnome/desktop/wm/keybindings" = {
      ...
      move-to-workspace-left = [ "<Shift><Control><Super>left" "<Shift><Super>n" ];
      move-to-workspace-right = [ "<Shift><Control><Super>right" "<Shift><Super>e" ];
      ...
      switch-to-workspace-right = [ "<Control><Super>right" "<Super>e" ];
      switch-to-workspace-up = [];
      switch-windows = [ "<Alt>Tab" ];
      switch-windows-backward = [ "<Shift><Alt>Tab" ];
      toggle-fullscreen = [ "" ];
      toggle-maximized = [ "F10" "<Super>y" ];
